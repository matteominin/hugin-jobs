...
/**
 * Scale AI's Greenhouse board — one request for the whole board. Keep technical intern/new-grad titles in Europe; the LLM does the final judging.
 */
export class ScaleAiSource extends GreenhouseSource {
  protected readonly defaultBoard = 'scaleai';
  protected readonly companyName = 'Scale AI';
