...
/**
 * Zscaler's Greenhouse board — one request for the whole board with descriptions inline. Zscaler has a sizeable European presence, so keep technical student-level titles in Europe and let the LLM judge. 0 EU intern jobs is a legitimate steady state.
 */
export class ZscalerSource extends GreenhouseSource {
  protected readonly defaultBoard = 'zscaler';
  protected readonly companyName = 'Zscaler';
