...
/**
 * Twilio's Greenhouse board — one request for the whole board with descriptions
 * inline. Twilio is remote-first with European engineering hubs (London,
 * Tallinn, and remote-EU), so keep technical student-level titles in Europe and
 * let the LLM judge. 0 EU intern jobs is a legitimate steady state.
 */
export class TwilioSource extends GreenhouseSource {
  protected readonly defaultBoard = 'twilio';
  protected readonly companyName = 'Twilio';
