...
/**
 * Asana's Greenhouse board — one request for the whole board with descriptions inline. Asana runs a Munich engineering hub, so keep technical student-level titles in Europe and let the LLM judge. 0 EU intern jobs is a legitimate steady state.
 */
export class AsanaSource extends GreenhouseSource {
  protected readonly defaultBoard = 'asana';
  protected readonly companyName = 'Asana';
