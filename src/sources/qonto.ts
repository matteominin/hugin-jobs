...
/**
 * Qonto publishes on an Ashby board, so the whole portal is one request. Paris-based fintech with software internships/stages across Europe; keep technical student-level titles and let the LLM judge.
 */
export class QontoSource extends AshbySource {
  protected readonly defaultBoard = 'qonto';
  protected readonly companyName = 'Qonto';
