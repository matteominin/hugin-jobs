...
/**
 * Block's Greenhouse board — one request for the whole board with descriptions inline. Block (Square, Cash App) has European engineering (Dublin, London), so keep technical student-level titles in Europe and let the LLM judge. 0 EU intern jobs is a legitimate steady state.
 */
export class BlockSource extends GreenhouseSource {
  protected readonly defaultBoard = 'block';
  protected readonly companyName = 'Block';
