...
/**
 * Glean's Greenhouse board (slug 'gleanwork') — one request for the whole board. Keep technical intern/new-grad titles in Europe and let the LLM judge.
 */
export class GleanSource extends GreenhouseSource {
  protected readonly defaultBoard = 'gleanwork';
  protected readonly companyName = 'Glean';
