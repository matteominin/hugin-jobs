...
/**
 * DeepL publishes on an Ashby board (descriptions inline), so the whole portal is one request. Cologne-based AI/translation company with real software and ML internships in Europe; keep technical student-level titles and let the LLM judge.
 */
export class DeepLSource extends AshbySource {
  protected readonly defaultBoard = 'deepl';
  protected readonly companyName = 'DeepL';
