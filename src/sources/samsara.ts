...
/**
 * Samsara's Greenhouse board — one request for the whole board with descriptions inline. Samsara has a European presence (London), so keep technical student-level titles in Europe and let the LLM judge. 0 EU intern jobs is a legitimate steady state.
 */
export class SamsaraSource extends GreenhouseSource {
  protected readonly defaultBoard = 'samsara';
  protected readonly companyName = 'Samsara';
