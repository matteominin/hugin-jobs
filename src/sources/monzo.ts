...
/**
 * Monzo's Greenhouse board — one request for the whole board. London-based bank with engineering graduate/intern roles in the UK; keep technical student-level titles and let the LLM judge.
 */
export class MonzoSource extends GreenhouseSource {
  protected readonly defaultBoard = 'monzo';
  protected readonly companyName = 'Monzo';
