...
/**
 * Okta's Greenhouse board — one request for the whole board with descriptions inline. Okta has European engineering hubs (Ireland, UK), so keep technical student-level titles in Europe and let the LLM judge. 0 EU intern jobs is a legitimate steady state.
 */
export class OktaSource extends GreenhouseSource {
  protected readonly defaultBoard = 'okta';
  protected readonly companyName = 'Okta';
