...
/**
 * Postman's Greenhouse board — one request for the whole board. Keep technical intern/new-grad titles in Europe and let the LLM judge.
 */
export class PostmanSource extends GreenhouseSource {
  protected readonly defaultBoard = 'postman';
  protected readonly companyName = 'Postman';
