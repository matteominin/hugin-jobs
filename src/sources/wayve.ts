...
/**
 * Wayve's Greenhouse board — one request for the whole board. Wayve is a London-based autonomous-driving company with heavy ML/research and software engineering, so technical student-level roles in Europe are kept for the LLM to judge.
 */
export class WayveSource extends GreenhouseSource {
  protected readonly defaultBoard = 'wayve';
  protected readonly companyName = 'Wayve';
