...
/**
 * Airtable's Greenhouse board — one request for the whole board. Keep technical intern/new-grad titles in Europe and let the LLM judge.
 */
export class AirtableSource extends GreenhouseSource {
  protected readonly defaultBoard = 'airtable';
  protected readonly companyName = 'Airtable';
