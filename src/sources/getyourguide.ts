...
/**
 * GetYourGuide's Greenhouse board — one request for the whole board. Berlin-based travel-tech with software internships/working-student roles in Europe; keep technical student-level titles and let the LLM judge.
 */
export class GetYourGuideSource extends GreenhouseSource {
  protected readonly defaultBoard = 'getyourguide';
  protected readonly companyName = 'GetYourGuide';
