...
/**
 * Robinhood's Greenhouse board — one request for the whole board with descriptions inline. Robinhood has a London engineering office, so keep technical student-level titles in Europe and let the LLM judge. 0 EU intern jobs is a legitimate steady state.
 */
export class RobinhoodSource extends GreenhouseSource {
  protected readonly defaultBoard = 'robinhood';
  protected readonly companyName = 'Robinhood';
