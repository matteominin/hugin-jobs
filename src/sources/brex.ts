...
/**
 * Brex's Greenhouse board — whole board with inline descriptions in one request. Brex is US-centric but runs a European engineering presence, so keep technical student-level roles in Europe and let the LLM judge.
 */
export class BrexSource extends GreenhouseSource {
  protected readonly defaultBoard = 'brex';
  protected readonly companyName = 'Brex';
